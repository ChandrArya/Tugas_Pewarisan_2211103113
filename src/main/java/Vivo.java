public class Vivo extends PhoneUser implements Phone {
    private int volume;
    ...
    public void powerOn() {
        if (!isPowerOn) {
            ...
            System.out.println("Vivo is already On");
        }
    }
    ...
    public void powerOff() {
        if (isPowerOn) {
            isPowerOn = false;
            System.out.println("Vivo Off");
        } else {
            System.out.println("Vivo is already Off");
        }
    }
